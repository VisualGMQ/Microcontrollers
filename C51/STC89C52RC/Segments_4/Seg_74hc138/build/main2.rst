      ...
      000003 02 00 74         [24]  301 	ljmp	_main
                                    ...
                                    311 ;------------------------------------------------------------
                                    312 ;	main2.c:6: void delay(int milli){
                                    313 ;	-----------------------------------------
                                    314 ;	 function delay
                                    315 ;	-----------------------------------------
      000062                        316 _delay:
      ...
      000073 22               [24]  339 	ret
                                    ...
                                    342 ;------------------------------------------------------------
                                    343 ;	main2.c:10: void main(){
                                    344 ;	-----------------------------------------
                                    345 ;	 function main
                                    346 ;	-----------------------------------------
      000074                        347 _main:
                                    348 ;	main2.c:11: while(1){
      000074                        349 00102$:
                                    350 ;	main2.c:12: A0=1;A1=0;A2=0;
                                    351 ;	assignBit
      000074 D2 80            [12]  352 	setb	_P0_0
                                    353 ;	assignBit
      000076 C2 81            [12]  354 	clr	_P0_1
                                    355 ;	assignBit
      000078 C2 82            [12]  356 	clr	_P0_2
                                    357 ;	main2.c:13: delay(100);
      00007A 90 00 64         [24]  358 	mov	dptr,#0x0064
      00007D 12 00 62         [24]  359 	lcall	_delay
                                    360 ;	main2.c:14: A0=0;A1=1;A2=0;
                                    361 ;	assignBit
      000080 C2 80            [12]  362 	clr	_P0_0
                                    363 ;	assignBit
      000082 D2 81            [12]  364 	setb	_P0_1
                                    365 ;	assignBit
      000084 C2 82            [12]  366 	clr	_P0_2
                                    367 ;	main2.c:15: delay(100);
      000086 90 00 64         [24]  368 	mov	dptr,#0x0064
      000089 12 00 62         [24]  369 	lcall	_delay
                                    370 ;	main2.c:17: }
      00008C 80 E6            [24]  371 	sjmp	00102$
                                    372 	.area CSEG    (CODE)
                                    373 	.area CONST   (CODE)
                                    374 	.area XINIT   (CODE)
