      ...
      000003 02 00 80         [24]  300 	ljmp	_main
                                    ...
                                    308 ;------------------------------------------------------------
                                    309 ;sec                       Allocated to registers 
                                    310 ;------------------------------------------------------------
                                    311 ;	main.c:3: void delay(int sec){
                                    312 ;	-----------------------------------------
                                    313 ;	 function delay
                                    314 ;	-----------------------------------------
      000062                        315 _delay:
                           ...
                           000001   322 	ar1 = 0x01
                           000000   323 	ar0 = 0x00
      000062 85 82 08         [24]  324 	mov	__mulint_PARM_2,dpl
      000065 85 83 09         [24]  325 	mov	(__mulint_PARM_2 + 1),dph
                                    326 ;	main.c:4: sec=sec*10;
      000068 90 00 0A         [24]  327 	mov	dptr,#0x000a
      00006B 12 00 92         [24]  328 	lcall	__mulint
      00006E AE 82            [24]  329 	mov	r6,dpl
      000070 AF 83            [24]  330 	mov	r7,dph
                                    331 ;	main.c:5: while(sec--);
      000072                        332 00101$:
      000072 8E 04            [24]  333 	mov	ar4,r6
      000074 8F 05            [24]  334 	mov	ar5,r7
      000076 1E               [12]  335 	dec	r6
      000077 BE FF 01         [24]  336 	cjne	r6,#0xff,00112$
      00007A 1F               [12]  337 	dec	r7
      00007B                        338 00112$:
      00007B EC               [12]  339 	mov	a,r4
      00007C 4D               [12]  340 	orl	a,r5
      00007D 70 F3            [24]  341 	jnz	00101$
                                    342 ;	main.c:6: }
      00007F 22               [24]  343 	ret
                                    344 ;------------------------------------------------------------
                                    345 ;Allocation info for local variables in function 'main'
                                    346 ;------------------------------------------------------------
                                    347 ;	main.c:8: void main(){
                                    348 ;	-----------------------------------------
                                    349 ;	 function main
                                    350 ;	-----------------------------------------
      000080                        351 _main:
                                    352 ;	main.c:9: while(1){
      000080                        353 00102$:
                                    354 ;	main.c:10: P0_0=1;
                                    355 ;	assignBit
      000080 D2 80            [12]  356 	setb	_P0_0
                                    357 ;	main.c:11: delay(2000);
      000082 90 07 D0         [24]  358 	mov	dptr,#0x07d0
      000085 12 00 62         [24]  359 	lcall	_delay
                                    360 ;	main.c:12: P0_0=0;
                                    361 ;	assignBit
      000088 C2 80            [12]  362 	clr	_P0_0
                                    363 ;	main.c:13: delay(2000);
      00008A 90 07 D0         [24]  364 	mov	dptr,#0x07d0
      00008D 12 00 62         [24]  365 	lcall	_delay
                                    366 ;	main.c:15: }
      000090 80 EE            [24]  367 	sjmp	00102$
                                    368 	.area CSEG    (CODE)
                                    369 	.area CONST   (CODE)
                                    370 	.area XINIT   (CODE)
